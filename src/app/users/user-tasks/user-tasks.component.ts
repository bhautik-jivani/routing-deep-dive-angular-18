...
export const resolveTitle: ResolveFn<string> = (activatedRouteSnapshot, routerStateSnapshot) => {
  return resolveUserName(activatedRouteSnapshot, routerStateSnapshot) + '\'s Task | EasyTask'
}
